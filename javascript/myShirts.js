...
if (firstName.slice(0, 10) === "" || firstName.slice(0, 10) === " ") {
console.log("First name is required.");
alert("First name is required.");
return;
} else if (lastName.slice(0, 10) === "" || lastName.slice(0, 10) === " ") {
console.log("Last name is required.");
alert("Last name is required.");
return;
} else if (email.slice(0, 10) === "" || email.slice(0, 10) === " ") {
console.log("Email is required.");
alert("Email is required.");
return;
} else if (phone.slice(0, 10) === "" || phone.slice(0, 10) === " ") {
